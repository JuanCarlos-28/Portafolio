export const proyectos = [
    {
        name: 'Casa de Cambio',
        urlImage: 'img/casa-de-cambio.png',
        url: 'https://casadecambioapp-juan-rivas.netlify.app/',
        description: 'Proyecto escolar realizado en JS y fue migrado a React',
    },
    {
        name: 'Heroes App',
        urlImage: 'img/heroes-app.png',
        url: 'https://heroes-app-react-28.netlify.app/',
        description: 'Aplicación de Heroes de Marvel & DC en React',
    },
    {
