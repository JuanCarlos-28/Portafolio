export const tecnologias = [
    {
        name: 'HTML',
        urlImage: './img/html-5.png',
        url: 'https://developer.mozilla.org/en-US/docs/Web/HTML',
        description: 'HTML (HyperText Markup Language) es el lenguaje de marcado estándar para la creación de páginas web. Define la estructura y el contenido de las páginas.',
        rate: 5,
    },
    {
        name: 'CSS',
    ...
    {
        name: 'Bootstrap',
        urlImage: './img/bootstrap.png',
        url: 'https://getbootstrap.com/',
        description: 'Bootstrap es un framework de diseño front-end que facilita la creación de interfaces web responsivas y atractivas. Proporciona componentes y estilos predefinidos.',
        rate: 4,
    },
    {
        name: 'React',
        urlImage: './img/react.png',
        url: 'https://reactjs.org/',
        description: 'React es una biblioteca de JavaScript para construir interfaces de usuario interactivas. Es especialmente eficaz para construir aplicaciones de una sola página (SPA).',
        rate: 3,
    },
    {
        name: 'SQL',
